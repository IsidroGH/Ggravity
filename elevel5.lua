...
local function createBackground()	
	...
	obj = objects.createBigStone(20,170,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	obj = objects.createBigStone(50,230,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	obj.rotation=120	
	obj = objects.createBigStone(112,247,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	obj.rotation=270
	
	obj = objects.createBigStone(100,170,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	obj = objects.createBigStone(148,187,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	obj.rotation=270
	obj = objects.createBigStone(210,187,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	obj.rotation=270
	
	mobile = objects.createSharpStone(30,125,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	mobile.rotation=110
end
...
function gameLoop()
			if (game.playing) then 
				...
				if mobileFrames>=mobileFramesRate then
					mobileFrames=0
					if mobile.x > 90 or mobile.x<20 then

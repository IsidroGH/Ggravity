...
local function newButtonHandler( self, event )	
	local result = true
		...
		elseif self.isFocus then
			...
			-- no interrumpo la propagacion del evento. Si toco la pantalla y muevo el dedo hacia el boton y lo levanto, no
			-- se dispara el evento ended sobre la pantalla => tengo que hacer result=false para que se propague este evento
			result=false
		end

...
local function createGround()
	...
	stone = objects.createBigStone(30,100,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	stone.rotation=110
	stone = objects.createBigStone(90,125,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	stone.rotation=110
	stone = objects.createBigStone(150,150,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	stone.rotation=110
	stone = objects.createBigStone(210,175,{ density=100.0, friction=0.5, bounce=0.2  },middleGroup,"static")
	stone.rotation=110
	
	stone = objects.createBigStone(320,181,{ density=100.0, friction=0.5, bounce=0.4  },middleGroup,"static")
	stone = objects.createBigStone(320,235,{ density=100.0, friction=0.5, bounce=0.4  },middleGroup,"static")

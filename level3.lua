...
local function createObjects()
	...
	-- Piedra pequeña
	local stone1 = objects.createSmallStone(200,-80,{ density=100.0, friction=0.5, bounce=0.0  },middleGroup)
	game.setDragable(stone1)
	
	--- Objeto elastico
	local elastic = objects.createElastic(150,-40, 0.9, middleGroup)
...
function new()	
	game.newLevel(levelGroup, backGroup, middleGroup, frontGroup, uiGroup, popupGroup, scenario, xScreens,yScreens,totalTime,totalBalls,goalBalls,3,250,320)	
